...
mkdir -p {../data/${CONFIG}3,../data/${CONFIG}4,../data/${CONFIG}5}

sed "s/--NODE--/${CONFIG}3/g; s/--PORT--/$((PORT+0))/g; s/--CONFIG--/${CONFIG}/g" rs/config-template.yaml > rs/${CONFIG}3.yaml
sed "s/--NODE--/${CONFIG}4/g; s/--PORT--/$((PORT+1))/g; s/--CONFIG--/${CONFIG}/g" rs/config-template.yaml > rs/${CONFIG}4.yaml
sed "s/--NODE--/${CONFIG}5/g; s/--PORT--/$((PORT+2))/g; s/--CONFIG--/${CONFIG}/g" rs/config-template.yaml > rs/${CONFIG}5.yaml
