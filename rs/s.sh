...
sed "s/--NODE--/${CONFIG}1/g; s/--PORT--/$((PORT+0))/g; s/--CONFIG--/${CONFIG}/g" rs/${CONFIG}.yaml > rs/${CONFIG}1.yaml
sed "s/--NODE--/${CONFIG}2/g; s/--PORT--/$((PORT+1))/g; s/--CONFIG--/${CONFIG}/g" rs/${CONFIG}.yaml > rs/${CONFIG}2.yaml
sed "s/--NODE--/${CONFIG}3/g; s/--PORT--/$((PORT+2))/g; s/--CONFIG--/${CONFIG}/g" rs/${CONFIG}.yaml > rs/${CONFIG}3.yaml
